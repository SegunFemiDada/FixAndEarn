        ...
        <div className="space-y-5">
          ...
          >
            <div className="grid gap-5 lg:grid-cols-2">
              <div className="overflow-hidden rounded-lg border border-[#D9E3F1] dark:border-[#2D3F55]">
                <div className="border-b border-[#D9E3F1] bg-[#F4F7FB] px-4 py-3 dark:border-[#2D3F55] dark:bg-[#16202E]">
                ...
                0 ? (
                  <div className="px-4 py-5 text-sm text-[#6B7C99] dark:text-[#8FA0BC]">
                    No deposits found.
                  </div>
                ) : (
                  <div className="divide-y divide-[#E2E8F0] dark:divide-[#2D3F55]">
                    {detail.deposits.map(
                      (deposit) => (
                        <div
                          key={deposit.id}
